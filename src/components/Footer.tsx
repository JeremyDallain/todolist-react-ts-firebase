...
export const Footer = () => {
  return (
    <footer className="h-12 flex justify-center items-center mt-6">
      ...
      <a href="https://github.com/JeremyDallain/todolist-react-ts-firebase" title='depôt github du projet' >
